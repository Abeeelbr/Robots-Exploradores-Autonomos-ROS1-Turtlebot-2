...
almacen_estaciones = {"HOME": (0, 0), "ESTACION1": (1, 1), "ESTACION2": (2, 2), "ESTACION3": (3, 3)}
...
class InterfazManager:
    ...
    def camera_callback(self, msg):
        ...
        try:
            ...
            #pil_image = pil_image.resize((600, 400), Image.ANTIALIAS) #CAMBIO: Cambio de ANTIALIAS a LANCZOS por incompatiblidad de versiones 
