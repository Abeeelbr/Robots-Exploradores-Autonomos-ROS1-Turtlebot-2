...
class TurtleBotObjectDetectionAction:
    ...
    def __init__(self):
        ...
        #            MODELO DE YOLO           
        # ************************************************
        self.model = torch.hub.load('ultralytics/yolov5', 'yolov5s')  # Puedes elegir otro modelo como yolov5m, yolov5l
    ...
    def detect_objects(self, cv_image):
            """
            Detecta objetos utilizando YOLOv5 en una imagen RGB.
            ...
            # Realiza la inferencia con YOLOv5
            results = self.model(cv_image)
            
            # Procesar los resultados
            detections = results.pandas().xyxy[0]  # DataFrame con los resultados de detección
            for index, row in detections.iterrows():
                ...
                object_info = {
                    'pixel_coordinates': Point(x=cX, y=cY, z=0.0),  # Puedes ajustar el valor de z si es necesario
                    'tipo': label,
                    'confidence': conf
                }
